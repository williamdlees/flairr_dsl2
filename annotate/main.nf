...
workflow {
	...
	tigger_j_call('j_call', 'sequence_alignment', 'false', 'false', makedb1.out.annotations, params.j_ref, "true")
	tigger_d_call('d_call', 'sequence_alignment', 'false', 'false', makedb1.out.annotations, params.d_ref, tigger_j_call.out.ready)	
	tigger_v_call('v_call', 'sequence_alignment', 'false', 'false', makedb1.out.annotations, params.v_ref, tigger_d_call.out.ready)	
	...
	create_germlines1(makedb2.out.annotations, tigger_v_call.out.personal_reference, tigger_d_call.out.personal_reference, tigger_j_call.out.personal_reference, "false", "pass-1")
	...
	haplotype_inference_report(makedb2.out.annotations, tigger_v_call.out.personal_reference, tigger_d_call.out.personal_reference, params.locus, params.haplotype_genes, single_clone_representative.out.ready)
	ogrdbstats_report(makedb2.out.annotations, makedb1.out.consolidated_ref, tigger_v_call.out.personal_reference, params.locus, "", params.species, haplotype_inference_report.out.ready)	
}