...
do
cd .
nextflow ../preprocess/main.nf --reads /mnt/f/clareo/easton_IgA/$sample*.fastq --outdir $(pwd)/results/IGH --sample_name $sample-IgA --constant_region AGM --nproc 40 --align_sets.nproc 8 -resume
