...
python3 /nf_root/python/pipeline_counts.py /nf_root/flairr_logs.toml /data/results/pipeline_counts.csv

echo "🔄 Running barcode_alignments.py..."
python3 /nf_root/python/barcode_alignments.py /nf_root/flairr_logs.toml /data/results/barcode_alignments.html
