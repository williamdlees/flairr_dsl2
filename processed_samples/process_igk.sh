...
nextflow ../preprocess/main.nf --reads /mnt/f/clareo/easton_short_samples/test_IGK.fastq --outdir $(pwd)/results/IGK --sample_name test_IGK --locus IGK --constant_region IGK
...
cd .
nextflow ../annotate/main.nf --reads /mnt/f/clareo/flairr_dsl2/processed_samples/results/IGK/reads/test_IGK_atleast-2.fasta --outdir $(pwd)/results/IGK --sample_name test_IGK --locus IGK --haplotype_genes IGKJ2
